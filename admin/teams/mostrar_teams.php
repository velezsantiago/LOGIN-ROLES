...
<a  class="btn btn-danger" href='/LOGIN ROLES/admin/index.php'><span class="material-symbols-outlined">
        ...
        <a  class="btn btn-info" href='/LOGIN ROLES/admin/teams/formulario_teams.php'><span class="material-symbols-outlined">
            groups_2
        </span>form</a>
...
<TD><a href=" modificar_teams.php? id=<?php echo $row['team_id'] ?>" class="btn btn-info" >Editar</a></TD>
<?php
}
